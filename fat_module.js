...
(function(){
  ...
  style.textContent = `
    ...
    .fat-fa .tail{ position:absolute; left:100px; top:60px; width:150px; height:26px; border-radius:10px; background:#fef08a; border:1px solid #d97706; display:flex; align-items:center; justify-content:center; font-weight:900; color:#7c2d12; font-size:12px; white-space:nowrap; }
  ...
  function formEster(gly, gi, fa){
    ...
    const line=svgLine(e.x1,e.y1,e.x2,e.y2,'#ffffff',4);
    // 标签
